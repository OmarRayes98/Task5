...
const CardTrending = ({image, price, title}) => {
  return (
    <div className="md:max-w-[382px] p-5 rounded-[10px] border-[1.5px] shadow-[0_0_10px_0_rgba(0,0,0,0.1)]">
      <img  src={image} className="rounded-[10px] object-cover w-full md:w-[342px] h-[242px]" alt="card image"/>
